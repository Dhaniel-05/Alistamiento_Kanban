...
class SabanaController {
  ...
  async asignarRap(req, res) {
    try {
      ...
      logger.error('Error en asignarRap', { stack: error.stack });
      return res.status(500).json({
        success: false,
  ...
  async quitarRap(req, res) {
    try {
      ...
      logger.error('Error en quitarRap', { stack: error.stack });
  ...
  async actualizarHoras(req, res) {
    ...
    try {
      ...
      logger.error('Error en actualizarHoras', { stack: error.stack });
 ...
 */
  ...
  async obtenerTrimestres(req, res) {
    try {
      ...
      logger.error('Error en obtenerTrimestres', { stack: error.stack });
  ...
  async obtenerSaberes(req, res) {
    try {
      ...
      logger.error('Error obteniendo saberes', { stack: error.stack });
      res.status(500).json({
        success: false,
  ...
  async obtenerProcesos(req, res) {
    try {
      ...
      logger.error('Error obteniendo procesos', { stack: error.stack });
      res.status(500).json({
        success: false,
  ...
  async obtenerCriterios(req, res) {
    try {
      ...
      logger.error('Error obteniendo criterios', { stack: error.stack });
      res.status(500).json({
        success: false,
